...
def img_convt():
    try:
        from PIL import Image
 # it will store the name of the file and
    # convert its file type to icon, we use this f'{}' to take arguments
...
ico_size.set(32) # default value if someone doesnt select a size
